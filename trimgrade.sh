...
## trim x seconds from the end of a video, apply haldclut color grading, and output user specified filename/format
##
## example:
...
ffmpeg -i "$1" -map 0 -t "$outputDur" -vf "movie="$3", [in] haldclut" "$4"
